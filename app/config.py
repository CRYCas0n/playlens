...
class Settings(BaseSettings):
    ...
    # v2 asks for Russian. Bumping this is how a prompt change reaches summaries that
    # already exist -- `should_generate` compares the stored prompt version against this
